        ...
        return (
            <footer style={this.shdowStyle()} className="text-lg-start mt-5">
                <div className="container p-4">
                    <div className={window.innerWidth >= 576 ?(window.innerWidth >= 992 ? 'row offset-2' : 'row')  :'row row offset-1'}>
                        ...
                        <div className="col-lg-6 col-md-6 mb-4 mb-md-0">
                            <ul className="list-unstyled  mb-0 pt-1">
                                <li className='mb-1'>
                                    ...
                                    <a className='contact-btn' href='https://www.instagram.com/kozeerofficial/' target="_blank" rel="noreferrer" >
